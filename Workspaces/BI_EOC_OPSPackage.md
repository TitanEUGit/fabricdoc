...
> The `BI_EOC_OPSPackage` is a legacy workspace. Today, it primarily serves as a backend datasource for other downstream reports rather than for direct end-user consumption.
